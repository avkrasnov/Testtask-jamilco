...
$this->addExternalJs(SITE_TEMPLATE_PATH.'/js/datepicker/datepicker.js');
$this->addExternalCss(SITE_TEMPLATE_PATH.'/js/datepicker/datepicker.css');
...
<div class="smart-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "smart-filter-horizontal"?>">
	<div class="smart-filter-section">
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smart-filter-form m-0">
			...
			<div class="d-flex">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?><?else:?>col-12<?endif?> mb-2 smart-filter-parameters-box bx-active">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?><?else:?>col-lg-12<?endif?> smart-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="smart-filter-container-modef"></span>
						...
						<div class="smart-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								case "P":
								?>
									<? $checkedItemExist = false; $checkedItem = $arItem["NAME"];?>
									<div class="smart-filter-input-group-dropdown">
										<div class="smart-filter-dropdown-block" onclick="smartFilter.showDropDownPopup(this, '<?=CUtil::JSEscape($key)?>')">
											<?foreach ($arItem["VALUES"] as $val => $ar)
											{
												if ($ar["CHECKED"])
												{
													$checkedItem = $ar["VALUE"];
													$checkedItemExist = true;
												}
											}
											?>
											<div class="smart-filter-dropdown-text<?if (!$checkedItemExist):?> value-all<?endif?>" data-role="currentOption" data-placeholder="<?=$arItem['NAME']?>">
												<?=$checkedItem?>
											</div>
										...
										<div class=""><div class="smart-filter-input-container smart-filter-calendar-container">
											<?$APPLICATION->IncludeComponent(
												...
												array(
													...
													'SHOW_INPUT' => 'Y',
													'INPUT_ADDITIONAL_ATTR' => 'autocomplete="off" placeholder="Дата" onkeyup="smartFilter.keyup(this); smartFilter.dateSelected(this)" onchange="smartFilter.keyup(this); smartFilter.dateSelected(this)"',
													'INPUT_NAME' => $arItem["VALUES"]["MIN"]["CONTROL_NAME"],
													'INPUT_VALUE' => $arItem["VALUES"]["MIN"]["HTML_VALUE"],
													'INPUT_NAME_FINISH' => $arItem["VALUES"]["MAX"]["CONTROL_NAME"],
													'INPUT_VALUE_FINISH' => $arItem["VALUES"]["MAX"]["HTML_VALUE"],
													'SHOW_TIME' => 'N',
													'HIDE_TIMEBAR' => 'Y',
												),
												null,
