...
{
	var isAll = controlId.split('_')[0] == 'all';
	...
	if (isAll) {
		currentOption.innerHTML = currentOption.dataset.placeholder;
		currentOption.classList.add('value-all');
	} else {
		currentOption.innerHTML = element.innerHTML;
		currentOption.classList.remove('value-all');
	}
	BX.PopupWindowManager.getCurrentPopup().close();
};

JCSmartFilter.prototype.dateSelected = function(input) {
